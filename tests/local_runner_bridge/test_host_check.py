...
def test_codex_manifest_version_match_is_exact(monkeypatch, tmp_path):
    exact = run_check(
        tmp_path / "exact",
        runner=FakeRunner(codex_version="codex-cli 0.156.1"),
        monkeypatch=monkeypatch,
    )
    stale = run_check(
        tmp_path / "stale",
    ...
    assert exact["bootstrap_contract"]["manifest_codex_version"] == "0.156.1"
    assert exact["codex_cli"]["version"] == "0.156.1"
...
def test_manifest_invalid_schema_blocks(monkeypatch, tmp_path):
    invalid_manifests = [
        ...
        [],
        {},
        {"protocol": "x", "paths": [], "codex": {"version": "0.156.1"}},
        {"protocol": "x", "paths": {}, "codex": {"version": "0.156.1"}},
        {"protocol": "x", "paths": {"venv": {}}, "codex": {"version": "0.156.1"}},
        {"protocol": "x", "paths": {"venv": []}, "codex": {"version": "0.156.1"}},
        {"protocol": "x", "paths": {"venv": 1}, "codex": {"version": "0.156.1"}},
        {"protocol": "x", "paths": {"venv": True}, "codex": {"version": "0.156.1"}},
        {"protocol": "x", "paths": {"venv": None}, "codex": {"version": "0.156.1"}},
        {"protocol": "x", "paths": {"venv": ""}, "codex": {"version": "0.156.1"}},
        {"protocol": "x", "paths": {"venv": "   "}, "codex": {"version": "0.156.1"}},
...
def test_ready_exit_attention_exit_blocked_exit_and_json_human(monkeypatch, capsys, tmp_path):
    ...
    def fake_ready(**kwargs):
        return {
            ...
            "codex_cli": {"selected_path": str(codex), "version": "0.156.1", "safe_launcher": True},
            "fresh_shell": {

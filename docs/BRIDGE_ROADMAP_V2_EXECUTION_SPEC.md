...
This section records the historical activation procedure. Tracker #168 is the designated canonical GitHub Roadmap surface. GitHub Issue #168 and Issue #175 were synchronized on 2026-07-02 and now record RV2-03 as the active node in Phase B change-control. No other Roadmap v2 node is active.

...
This section records the historical activation procedure. Tracker #168 is the designated canonical GitHub Roadmap surface, but it currently remains stale. Repository documentation records RV2-03 as the active node in Phase B change-control. GitHub Issue #175 and tracker #168 require a separately approved GitHub truth-sync write. No other Roadmap v2 node is active.

# Authenticated Live Explicit Fetch Smoke Evidence 150
...
- Issue role: core
- Alignment: core
- Explicit reference used: https://github.com/HarryWhite-TW/local-ai-workbench/issues/114#issuecomment-4618242459
